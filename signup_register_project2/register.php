...
if(isset($_POST['reg_username']) && 
   ...
   isset($_POST['reg_last_name'])){
    ...
    $reg_username = protectHTML($_POST['reg_username']);
    $reg_password = protectHTML($_POST['reg_password']);

        $reg_password_hash =protectHTML(md5($reg_password));

    

    $reg_first_name = protectHTML($_POST['reg_first_name']);
    $reg_last_name = protectHTML($_POST['reg_last_name']);
